...
<template>
    <el-dialog v-model="isVisiable" title="Add new line">
        <el-form :model="form">
            ...
            <el-form-item label="Max. in Lineup" label-width="140px">
                <el-input type="number" v-model="form.max_in_lineup" autocomplete="off" />
            </el-form-item>
        </el-form>
        <template #footer>
